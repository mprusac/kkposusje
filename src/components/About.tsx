...
const achievements = [
  ...
  {
    title: "Dugogodišnji prvoligaš BiH",
  ...
  {
    title: "FIBA Kup Radivoja Koraća (1998./99.)",
  ...
  {
    title: "Finalisti Kupa Herceg-Bosne",
    subtitle: "Zapaženi rezultati u državnim kup natjecanjima",
    description: "Česti sudionik nacionalnih završnih turnira i polufinala Kupa BiH",
    icon: Medal,
    emoji: "🥈",
  },
  {
  ...
  {
    title: "Ženski omladinski pogon (2002.)",
