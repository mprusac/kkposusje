          ...
          >
            {latestNews.map((item, index) => (
              <Link
                ...
                className="group flex-shrink-0 bg-background rounded-lg overflow-hidden transition-all duration-300 hover:scale-[1.02] hover-lift border border-primary/40 hover:border-primary/80 snap-start flex flex-col"
                style={{
